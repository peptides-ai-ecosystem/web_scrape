...
def setup_argument_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Scrape peptide data and sync to PostgreSQL. "
                    "By default, runs both scrape and sync. "
    ...
    parser.add_argument("--sync", action="store_true", help="Run sync only (no scraping)")
...
def main() -> None:
   ...
   """
    ...
    any_flag = args.scrape or args.sync or args.evaluate
