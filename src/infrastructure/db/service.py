...
class DbManager:
    ...
    def get_all_administration_methods(self) -> list:
        """Fetch all administration methods from DB as list of dicts (id, name)."""
        return self.service.lookup.get_all("administration_methods")
